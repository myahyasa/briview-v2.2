...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('ups.post') }}" id="form-tambah-data-ups" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    <h4 class="text-primary mb-4">Tambah Data Ups</h4>
                    <hr class="mb-4">
                    <div class="form-group row">
                        <label for="vendor_name" class="col-sm-2 col-form-label text-black">Nama Vendor <span style="color: red;">*</span></label>
                        <div class="col-sm-10">
                            <select class="form-control font-weight-bold" name="vendor_name" id="ups_ambilDataVendor">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('brand') is-invalid @enderror" name="brand" id="brand" placeholder="nama brand, contoh: VEKTOR" value="{{ old('brand') }}">
                            @if ($errors->has('brand'))
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('sn_ups') is-invalid @enderror" name="sn_ups" id="sn_ups" placeholder="serial number ups, contoh: MA9180AA80171TES" value="{{ old('sn_ups') }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('type') is-invalid @enderror" name="type" id="type" placeholder="tipe, contoh: RS 2000T + Battery" value="{{ old('type') }}">
                            @if ($errors->has('type'))
