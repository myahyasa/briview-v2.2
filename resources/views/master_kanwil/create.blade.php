...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('masterKanwil.post') }}" id="form-tambah-data-master-kanwil" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control input1 @error('branchcode_kanwil') is-invalid @enderror" name="branchcode_kanwil" id="branchcode_kanwil" maxlength="4"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="kode kanwil, contoh 1234" value="{{ old('branchcode_kanwil') }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('kanwil') is-invalid @enderror" name="kanwil" id="kanwil" placeholder="nama kanwil, contoh: denpasar" value="{{ old('kanwil') }}">
