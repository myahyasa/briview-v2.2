...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('masterUker.post') }}" id="form-tambah-data-master-uker" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control input1 @error('branchcode_uker') is-invalid @enderror" name="branchcode_uker" id="branchcode_uker" maxlength="4"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="kode uker, contoh 0001" value="{{ old('branchcode_uker') }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('uker') is-invalid @enderror" name="uker" id="uker" placeholder="nama uker, contoh: Baturaja" value="{{ old('uker') }}">
                            @if ($errors->has('uker'))
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('jenis_uker') is-invalid @enderror" name="jenis_uker" id="jenis_uker" placeholder="jenis uker, contoh: KANCA" value="{{ old('jenis_uker') }}">
