...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('machineInfo.post') }}" id="form-tambah-data-machine-info" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control input1 @error('sn_machine') is-invalid @enderror" name="sn_machine" id="sn_machine" placeholder="serial number machine, contoh: 0006" value="{{ old('sn_machine') }}">
