...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('cctv.update',[$cctv_edit->id]) }}" id="form-tambah-data-cctv" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    <h4 class="text-primary mb-4">Edit Data Cctv</h4>
                    <hr class="mb-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control font-weight-bold" name="vendor_name" id="cctv_ambilDataVendor">
                                <option value="{{ old('vendor_name') ? old('vendor_name') : $cctv_edit->tb_master_vendor_id }}">{{ explode('|', old('vendor_name'))[1] ?? $cctv_edit->vendor_name }}</option>
                            </select>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('brand') is-invalid @enderror" name="brand" id="brand" placeholder="nama brand, contoh: UNV" value="{{ old('brand') ? old('brand') : $cctv_edit->brand }}">
                            @if ($errors->has('brand'))
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('sn_cctv') is-invalid @enderror" name="sn_cctv" id="sn_cctv" placeholder="serial number digital signage, contoh: 210235TQV23217002278"
                                value="{{ old('sn_cctv') ? old('sn_cctv') : $cctv_edit->sn_cctv }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('type') is-invalid @enderror" name="type" id="type" placeholder="tipe, contoh: UNV IP Camera Fixed Dome Infra Red 2MP IPC399SB-28PI-CMX"
                                value="{{ old('type') ? old('type') : $cctv_edit->type }}">
                            @if ($errors->has('type'))
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('no_spk') is-invalid @enderror" name="no_spk" id="no_spk" placeholder="no spk, contoh: B.1310.P-PLO/IGP/PTT/07/2021"
                                value="{{ old('no_spk') ? old('no_spk') : $cctv_edit->no_spk }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('project_name') is-invalid @enderror" name="project_name" id="project_name" placeholder="nama projek, contoh: CRM MS 1325"
                                value="{{ old('project_name') ? old('project_name') : $cctv_edit->project_name }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control input1 @error('year') is-invalid @enderror" name="year" id="year" maxlength="4"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="tahun, contoh: 2022" value="{{ old('year') ? old('year') : $cctv_edit->year }}">
                            @if ($errors->has('year'))
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('remarks') is-invalid @enderror" name="remarks" id="remarks" placeholder="Remarks" value="{{old('remarks') ? old('remarks') : $cctv_edit->remarks}}">
