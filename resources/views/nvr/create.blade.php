...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('nvr.post') }}" id="form-tambah-data-nvr" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    <h4 class="text-primary mb-4">Tambah Data Nvr</h4>
                    <hr class="mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('sn_nvr') is-invalid @enderror" name="sn_nvr" id="sn_nvr" placeholder="serial number ups, contoh: 210235XBY33216000429" value="{{ old('sn_nvr') }}">
