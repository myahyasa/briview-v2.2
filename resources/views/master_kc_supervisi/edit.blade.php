...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <form action="{{ route('masterKcSupervisi.update',[$masterKcSupervisi_edit->id]) }}" id="form-tambah-data-master-kc-supervisi" method="POST">
                @csrf
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control input1 @error('branchcode_kc_supervisi') is-invalid @enderror" name="branchcode_kc_supervisi" id="branchcode_kc_supervisi" maxlength="4"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="kode kc supervisi, contoh 0146"
                                value="{{ old('branchcode_kc_supervisi') ? old('branchcode_kc_supervisi') : $masterKcSupervisi_edit->branchcode_kc_supervisi }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('kc_supervisi') is-invalid @enderror" name="kc_supervisi" id="kc_supervisi" placeholder="nama kc_supervisi, contoh: denpasar"
                                value="{{ old('kc_supervisi') ? old('kc_supervisi') : $masterKcSupervisi_edit->kc_supervisi }}">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control input1 @error('remarks') is-invalid @enderror" name="remarks" id="remarks" placeholder="Remarks"
                                value="{{old('remarks') ? old('remarks') : $masterKcSupervisi_edit->remarks}}">
